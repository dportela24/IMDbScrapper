...
class ScrapingService(
    ...
    val TV_SERIES_METADATA_TYPE = "video.tv_show"
    ...
    fun scrapTitle(imdbId: String) : Series {
        ...
        return buildSeries(doc)
    }

    fun buildSeries(doc: Document) : Series {
    ...
    private fun parseDurationFromString(input: String) : Duration {
        ...
        val groupValues = matchGroupsInRegex(trimmedInput, "(?:(\\d+)h)?(?:(\\d+)m)?")
    ...
    private fun matchGroupsInRegex(input: String, pattern: String) : List<String>? {
